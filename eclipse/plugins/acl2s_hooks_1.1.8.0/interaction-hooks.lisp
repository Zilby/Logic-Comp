...
(acl2::begin-book t :ttags ((:acl2s-interaction) (:acl2s-protection)
                            (:acl2s-super-history) (defcode)));$ACL2s-Preamble$|#
...
(modify-raw-defun read-object original-read-object (chan st)
                  (progn (when (and (acl2::live-state-p st)
                                    (eq chan *standard-oi*)
                                    (acl2s-interactionp st))
